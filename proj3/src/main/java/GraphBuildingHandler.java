...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<Long> tempWay;
    private String tempName;
    private String tempRoadType;
    private String tempMaxSpeed;
    private boolean tempValidWay;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            activeState = "way";
            // A new way begins. Create a new temp array and initialize temp variables.
            tempWay = new ArrayList<Long>();
            tempValidWay = false;
            tempMaxSpeed = "";
            tempRoadType = "";
            tempName = "";
            ...
            if (k.equals("maxspeed")) {
                ...
                tempRoadType = v;
                tempValidWay = ALLOWED_HIGHWAY_TYPES.contains(v);
...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
            ...
            lastVertex.addLocation(location);
        }
    }
