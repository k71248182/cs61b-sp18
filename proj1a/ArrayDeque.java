...
public class ArrayDeque<T> {
    ...
    /* Helper function: compute the index immediately before a given index. */
    ...
    /* Helper function: compute the index immediately after a given index. */
    ...
    /* Helper function: return the correct array index given the deque index. */
    ...
    /* Helper function: resize array. */
    /* resized array always start from position zero */
    ...
    /* Helper function: calculate the optimal array size based on deque length. */
    private void optimalCapacity(){
        if (size < items.length * 0.25){
            int capacity = (int) Math.round(items.length * 0.5);
            resize(capacity);
        }
    }
